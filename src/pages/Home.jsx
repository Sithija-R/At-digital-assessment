  ...
  return (
    <div className="">
      <section className="relative h-screen w-full px-0 md:px-15">
        ...
        <div className="bg-gradient-to-r from-analogous2 to-dark_color text-white p-8 font-interw-full md:max-w-[650px] relative md:absolute md:bottom-10 z-10">
          <h1 className="font-bold text-5xl mb-4 transition-transform duration-300 hover:scale-101 cursor-default">
            We Crush Your Competitors, Goals, And Sales Records - Without The
            B.S.
          </h1>

          <button className="bg-secondary mt-5 text-md uppercase px-4 py-2 rounded font-semibold hover:bg-[#d2731e] transition cursor-pointer">
      ...
      <section className=" flex flex-col items-center mx-auto my-10 space-y-10 px-8">
        {services.map(({ title, description, imgSrc, reverse }) => (
          ...
          >
            <img src={imgSrc} alt={title} className="w-150 object-contain" />
            <div className="max-w-xl text-center sm:text-left ">
              <h2 className="text-primary font-semibold font-poppins text-3xl mb-3 transition-transform duration-300 hover:scale-101 cursor-default">
                {title}
              </h2>
        ...
        <div className="space-y-4">
          {faqItems.map((item) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex justify-between  font-semibold text-2xl gap-3 ${
                    isOpen ? "text-primary" : ""
                  }`}
                >
